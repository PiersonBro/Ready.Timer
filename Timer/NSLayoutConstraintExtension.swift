...
extension NSLayoutConstraint {
    class func generateConstraints(label: UIView, toItem: UIView, xMultiplier: CGFloat, yMultiplier: CGFloat) -> (xConstraint: NSLayoutConstraint, yConstraint: NSLayoutConstraint) {
